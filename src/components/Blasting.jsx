...
const Blasting = () => {
    return (
        <section>
            <div className="mycontainer mt-lg-95" id='services'>
                <h2 className='font-titlingGothic mb-0 fw-bold fs-48 lh-57 color-blue text-center z-1 position-relative'>Why Choose Dry Ice Blasting for Your Car?</h2>
