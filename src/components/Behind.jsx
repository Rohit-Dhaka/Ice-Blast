    ...
    return (
        <section className='behind-background'>
            ...
            <div className="mycontainer pt-sm-0 pt-4">
                <div className="d-flex flex-column align-items-center pb-sm-50 pb-4 pt-37">
                    <h2 className='mb-0 font-titlingGothic fw-bold fs-48 lh-57 text-center text-white max-w-480'>Behind the Scenes
